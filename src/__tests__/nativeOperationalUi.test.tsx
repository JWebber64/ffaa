...
vi.mock("../features/native-waivers/useNativeWaivers", () => { const state = { status: "ready", message: "ready", settings: null, teams, waiverState: { revision: 1, playerCount: 300, settingsVersionId: "settings-1", nextProcessingAt: "2026-09-22T13:00:00.000Z", lastRunId: "run-1", updatedAt: "2026-09-03T07:00:00.000Z" }, players: [], teamStates: [{ franchiseId: "one", faabRemaining: 80, priority: 1, standingsRank: 1, priorityWeek: 1, weeklyAcquisitions: {}, revision: 1 }], claims: [], receipts: [{ id: "waiver-1", runId: "run-1", claimId: "claim-1", franchiseId: "one", status: "won", claimsEvaluated: 1, winningBid: 10, nextHighestBid: null, priorityBefore: 1, priorityAfter: 2, tiebreakerUsed: "priority", failures: [], addPlayerId: "player-3", dropPlayerId: "", remainingFaab: 80, processedAt: "2026-09-02T13:00:00.000Z" }] }; return { useNativeWaivers: () => state }; });
