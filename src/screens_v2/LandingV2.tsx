    ...
    <div className="min-h-screen text-white">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <GlassPanel className="text-center mb-16 p-6 md:p-8">
          <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-[var(--a1)] to-[var(--a2)] bg-clip-text text-transparent">
            FFAA
          </h1>
        ...
        <div className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <GlassCard className="text-center p-6 transition-all duration-200 ease-out hover:-translate-y-0.5 h-full">
              <div className="w-16 h-16 bg-gradient-to-r from-[var(--a1)] to-[var(--a2)] rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">
                1
              </div>
            ...
            <GlassCard className="text-center p-6 transition-all duration-200 ease-out hover:-translate-y-0.5 h-full">
              <div className="w-16 h-16 bg-gradient-to-r from-[var(--a2)] to-[var(--a1)] rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">
                2
              </div>
        ...
        <div className="py-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-[var(--text-1)]">
            <div className="flex items-start space-x-3">
              <span className="text-[var(--a1)]">✓</span>
