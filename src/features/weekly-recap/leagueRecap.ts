...
export function buildLeagueRecap(week: RecapWeek): LeagueRecap | null {
  ...
  const caveats = ["Awards use this league's actual weekly scoring. Equal results share honors; FLEX honors use the recorded slot. A player can earn both a natural-position and a FLEX honor, without adding any team points."];
