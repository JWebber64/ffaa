  ...
  if (state.status === "loading") {
    return (
      <main className="history-shell history-state" aria-busy="true">
        <div className="history-state-kicker">Permanent league archive</div>
  ...
  if (state.status === "error" || !state.data) {
    return (
      <main className="history-shell history-state is-error">
        ...
        <h1>This league is not in the permanent archive yet</h1>
        <p>{state.error}</p>
    ...
    <div className="history-shell">
      <header className="history-masthead">
        <div>
          ...
          <span className="history-kicker">Permanent league archive</span>
