...
const tools = [
  ...
  { to: "/draft-order", title: "Draft Order Showdown", description: "Set a draft or nomination order with one of three football games, then replay or share the showdown.", detail: "Draft-night ceremony", icon: Dices, group: "prepare", weight: "wide", image: "images/draft-room-editorial.png" },
